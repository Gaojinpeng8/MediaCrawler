...
class ZhihuCsvStoreImplement(AbstractStore):
    ...
    async def store_creator(self, creator: Dict):
        """
        Zhihu creator CSV storage implementation
        Args:
...
class ZhihuDbStoreImplement(AbstractStore):
    ...
    async def store_creator(self, creator: Dict):
        """
        Zhihu creator DB storage implementation (not used, no-op)
        Args:
            creator: creator item dict
        ...
        Returns:
            None
        """
        # 数据库 schema 中不存在独立的 creator 表，保持业务不变
        # 此方法作为占位实现以满足抽象类要求
        return None
...
class ZhihuJsonStoreImplement(AbstractStore):
    ...
    async def store_creator(self, creator: Dict):
        """
        Zhihu creator JSON storage implementation
        Args:
            creator: creator item dict
